...
```
flatpak --user install flathub org.gnome.Sdk/x86_64/50
flatpak --user install flathub org.gnome.Sdk.Debug/x86_64/50
flatpak --user update          org.gnome.Sdk/x86_64/50
flatpak --user update          org.gnome.Sdk.Debug/x86_64/50
```
